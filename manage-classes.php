...
if(isset($_GET['delid'])){
    $delid = $_GET['delid'];
    $sql = "DELETE FROM tblclasses WHERE id = :delid";
    ...
    $query -> execute();
        if($query->rowCount() > 0){
            ...
            echo "<script>alert('Sorry, Class Not Found!');</script>";
        }
...
<a href="manage-classes.php?delid=<?php echo ($result->id);?>" onclick="return confirm('Do you really want to Delete ?');"><i class="fa fa-trash-o"></i></a>
