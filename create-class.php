...
<html lang="en">
    <head>
        ...
        <title>Staff | Create Class</title>
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">i.e; Form</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">e.g; 1,2,4,5 etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Stream</label>
                                                        <div class="">
                                                            <input type="text" name="section" class="form-control" required="required" id="success">
                                                            <span class="help-block">e.g; A, B, C </span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
