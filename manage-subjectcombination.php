...
if(strlen($_SESSION['alogin'])=="")
    ...
    header("Location: index.php"); 
        ...
        if(isset($_GET['acid'])){
            ...
            $query->execute();
            $msg="Subject Activation successfully";
            }
        ...
        if(isset($_GET['did'])){
            ...
            $query->bindParam(':status',$status,PDO::PARAM_STR);
            $query->execute();
            $msg="Subject Deactivation successfully";
            }
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Staff | Manage Subjects Combination</title>
...
tblsubjectcombination.id 
as scid,tblsubjectcombination.status 
from tblsubjectcombination join tblclasses on tblclasses.id=tblsubjectcombination.ClassId  join tblsubjects on tblsubjects.id=tblsubjectcombination.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->ClassName);?> &nbsp; <?php echo htmlentities($result -> ClassNameNumeric); ?> &nbsp; Stream-<?php echo htmlentities($result->Section);?></td>
