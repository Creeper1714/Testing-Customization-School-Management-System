...
if(strlen($_SESSION['alogin'])=="")
    ...
    $stid=intval($_GET['stid']);
        ...
        $msg="$studentname's information has been updated successfully!";
        }
...
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
<input type="text" name="classname" class="form-control" id="classname" value="<?php echo htmlentities($result->ClassName); ?><?php echo htmlentities($result->ClassNameNumeric); ?>&nbsp;Stream-(<?php echo htmlentities($result->Section)?>)" readonly>
                                                        </div>
                                                    </div>
                                                <div class="form-group">
